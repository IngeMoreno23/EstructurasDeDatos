...
int main(){
    ...
    std::cout<<"> Impresión de la lista de adyacencia (quitando el arco inexistente de 1 a 1): \n";
    try{
    ...
    std::cout<<"> Impresión de la lista de adyacencia creada con un contenedor como parámetro: \n";
    testGraphContainer.print();
    
    std::cout<<"> Recorridos DFS: \n";
    testGraphContainer.DFS(0);
    testGraphContainer.DFS(1);
    
    std::cout<<"> Recorridos BFS: \n";
    testGraphContainer.BFS(0);
    testGraphContainer.BFS(1);
    
    std::cout<<"> Recorridos DFS y BFS en grafos vacíos: \n";
    try{
        testLoadGraph.DFS(0);
        testLoadGraph.BFS(0);
    } catch(std::out_of_range& ex){
